...
*/
class ImagenComponent extends Object {
    /*
    ...
    */
    function upload_image_and_thumbnail($data, $imgscale, $thumbscale, $folderName, $square) {        
        if (strlen($data['name'])>4) {
            ...
            $parentuploaddir= "img/".$folderName; // el directorio para esta imgen que contiene a big y a small
            ...
            if(!is_dir($parentuploaddir)) mkdir($parentuploaddir,0777, true);
            ...
            $id_unic = str_replace(array(".",","), "", microtime(true));
            $filename = $id_unic;
